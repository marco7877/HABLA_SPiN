...
parser.add_argument("--output_dir",default="func_preproc_ME/", type =str,
                    ...
                    Default is func_preproc:
                        ...
                        -func
                        -func_preproc""")
parser.add_argument("--despike", default=False,type=bool,
                    help="Despike data? Default is False")                        
...
preproc_bold= [niifti.replace("sbref","bold_dsd") for niifti in preproc_bold]
####### Output names/dir ######################################################
